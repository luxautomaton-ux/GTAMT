...
const fallbackNewsFeed = {
  ...
  rightsNote: 'Fallback official source desk. Run npm run news:scrape to refresh live RSS headlines.',
  sources: [
    ...
    <div className="news-room-page text-left w-full">
      <section className="news-room-hero">
        ...
        <aside className="news-scanner-panel">
          <span className="font-mono text-pink text-xs uppercase">// GTA Money Team scanner</span>
          <h2>Latest GTA News Into Paid Member Value</h2>
          <p>
            The internal scraper refreshes source links for GTA VI, Rockstar, Take-Two, FiveM, creator, and scam-watch stories. Members see the polished briefing, not the tooling.
          </p>
      ...
      <section className="news-watchlist">
        ...
        <div className="news-watch-grid">
          {(feed.officialWatchlist || fallbackNewsFeed.officialWatchlist).map((source) => (
